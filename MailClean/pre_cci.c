# 1 "c:\\users\\aperepelkina\\documents\\vugen\\scripts\\mailclean\\\\combined_MailClean.c"
...
# 1 "c:\\users\\aperepelkina\\documents\\vugen\\scripts\\mailclean\\\\combined_MailClean.c" 2
...
# 2 "c:\\users\\aperepelkina\\documents\\vugen\\scripts\\mailclean\\\\combined_MailClean.c" 2
...
char WebSocketReceive0[] = "{\"messageType\":\"hello\",\"uaid\":\"053ee0060f2d4255a9f8a9f2d9146977\",\"statu"
...
# 3 "c:\\users\\aperepelkina\\documents\\vugen\\scripts\\mailclean\\\\combined_MailClean.c" 2
...
# 4 "c:\\users\\aperepelkina\\documents\\vugen\\scripts\\mailclean\\\\combined_MailClean.c" 2
...
{	
	...
	lr_end_transaction("UC_01_SaveToken", 2);
	...
	web_url("info", 
		...
		"Mode=HTTP", 
		"LAST");
	lr_end_transaction("UC_02_Info", 2);
	...
	lr_start_transaction("UC_03_Auth");
		...
		"LAST");
	lr_end_transaction("UC_03_Auth", 2);
	...
	lr_end_transaction("UC_04_Inbox", 2);
	...
	web_url("inbox_2",
		...
		"Mode=HTTP",
		"LAST");
	lr_end_transaction("UC_05_Inbox2", 2);
	...
	lr_end_transaction("UC_06_NaviData", 2);
	...
	web_url("unread",
		...
		"LAST");
	lr_end_transaction("UC_07_Unread", 2);
	...
	web_url("aliases",
		...
		"LAST");
	lr_end_transaction("UC_08_Aliases", 2);
	...
	web_url("smart_2",
 	...
 	lr_end_transaction("UC_09_Smart2", 2);
	...
	web_url("security",
		...
		"LAST");
 	lr_end_transaction("UC_10_Security", 2);
	...
	web_url("short",
		...
		"LAST");
 	lr_end_transaction("UC_11_Short", 2);
	...
	web_url("requests",
		...
		"Mode=HTTP",
		"LAST");
	lr_end_transaction("UC_12_Request", 2);
	...
	web_url("unread_2",
		...
		"LAST");
	lr_end_transaction("UC_13_Unread", 2);
	...
	web_submit_data("short_2",
		...
		"LAST");
	lr_end_transaction("UC_14_Short", 2);
	...
	web_url("smart_3",
		...
		"Mode=HTTP",
		"LAST");
	lr_end_transaction("UC_15_Smart3", 2);
	...
	web_url("smart_4",
		...
		"LAST");
	lr_end_transaction("UC_16_Smart4", 2);
	...
	web_url("suggest",
		...
		"LAST");
	lr_end_transaction("UC_17_Suggest", 2);
	...
	web_url("smart_5",
		...
		"LAST");
	lr_end_transaction("UC_18_Smart5", 2);
	...
	web_submit_data("send",
		...
		"LAST");
	lr_end_transaction("UC_19_Send", 2);
	...
	web_url("thread",
		...
		"Mode=HTTP",
		"LAST");
	lr_end_transaction("UC_20_Thread", 2);
	...
	web_url("thread_2",
		...
		"Mode=HTTP",
		"LAST");
	lr_end_transaction("UC_21_Thread2", 2);
	...
	web_url("NaviData_3",
		...
		"Mode=HTTP",
		"LAST");
	lr_end_transaction("UC_22_NaviData", 2);
	...
	web_url("logout",
		...
		"LAST");
	lr_end_transaction("UC_23_Logout", 2);
	...
	web_url("NaviData_4", 
		...
		"LAST");
	lr_end_transaction("UC_25_NaviData4", 2);
	...
	lr_end_transaction("UC_26_Info2", 2);
	...
	web_custom_request("auth_2",
		...
		"LAST");
	lr_end_transaction("UC_27_Auth2", 2);
	...
	web_url("inbox_3",
		...
		"Mode=HTTP",
		"LAST");
	lr_end_transaction("UC_28_Inbox3", 2);
	...
	web_url("NaviData_5",
		...
		"Mode=HTTP",
		"LAST");
	lr_end_transaction("UC_29_NaviData5", 2);
	...
	web_url("aliases_2",
		...
		"Mode=HTTP",
		"LAST");
	lr_end_transaction("UC_30_Alises", 2);
	...
	web_url("unread_3",
		...
		"Mode=HTTP",
		"LAST");
	lr_end_transaction("UC_31_Unread", 2);
	...
	web_url("security_2",
		...
		"Mode=HTTP",
		"LAST");
	lr_end_transaction("UC_32_Security", 2);
	...
	web_url("short_3",
		...
		"LAST");
	lr_end_transaction("UC_33_Short3", 2);
	...
	web_url("unread_4",
		...
		"URL=https://trk.mail.ru/i/ac5sf6?mt_sub1=e.mail.ru&mt_sub5=2", "Referer=https://e.mail.ru/", "ENDITEM",
		"LAST");
	lr_end_transaction("UC_35_Unread4", 2);
	...
	lr_end_transaction("UC_36_Requests2", 2);
...
lr_start_transaction("UC_37_Thread3");
	...
	web_url("thread_3",
		...
		"Mode=HTTP",
		"LAST");
		lr_end_transaction("UC_37_Thread3", 2);
	...
	web_url("hash",
		...
		"LAST");
	lr_end_transaction("UC_38_Hash", 2);
	...
	web_submit_data("marks",
		...
		"LAST");
	lr_end_transaction("UC_39_Marks", 2);
	...
	web_submit_data("update",
		...
		"Name=token", "Value=be73068278c39cb88707fddb013e2c9f:6304585c51455b64195657000a03070d00030b50060054570d0e03010354555d5207000a5c0a5209571654475c6e4206", "ENDITEM",
		"LAST");
	lr_end_transaction("UC_40_Update", 2);
	...
	web_submit_data("short_4",
		...
		"LAST");
	lr_end_transaction("UC_41_Short", 2);
	...
	web_submit_data("update_2",
		...
		"LAST");
	lr_end_transaction("UC_42_Update2", 2);
	...
	web_submit_data("send_2",
		...
		"Name=token", "Value=3929717862263664589521945105572612953507:6304585c51455b6419070b05000400020a020101030a010301030c0801000000040200090c0d06020706070e000201070e105146516d4409", "ENDITEM",
		"LAST");
	lr_end_transaction("UC_43_Send3", 2);
	...
	lr_end_transaction("UC_44_Thread4", 2);
	...
	web_url("thread_5",
		...
		"LAST");
	lr_end_transaction("UC_45_Thread", 2);
	...
	web_url("force_2",
		...
		"LAST");
	lr_end_transaction("UC_46_Force2", 2);
	...
	web_url("NaviData_6",
		...
		"LAST");
	lr_end_transaction("UC_47_NaviData6", 2);
	...
	web_url("logout_2",
		...
		"Mode=HTTP",
		"LAST");
lr_end_transaction("UC_48_Logout2", 2);




lr_end_transaction("0_MAIL", 2);

	return 0;
}
# 5 "c:\\users\\aperepelkina\\documents\\vugen\\scripts\\mailclean\\\\combined_MailClean.c" 2
...
# 6 "c:\\users\\aperepelkina\\documents\\vugen\\scripts\\mailclean\\\\combined_MailClean.c" 2
